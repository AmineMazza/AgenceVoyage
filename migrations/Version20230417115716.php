 ...
 */
final class Version20230417115716 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offre DROP id_user_id, CHANGE ballerr_etour baller_retour TINYINT(1) NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE offre ADD id_user_id INT NOT NULL, CHANGE baller_retour ballerr_etour TINYINT(1) NOT NULL');
